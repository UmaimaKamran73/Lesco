...
public class EmployeeEditTarrifInfo extends JFrame {
    public JLabel jlMeterType, jlCustType;
    public JLabel jlFixedPrice, jlTaxPercentage, jlRegularUnitPrice, jlPeakUnitPrice;
    public JTextField tfFixedPrice, tfTaxPercentage, tfRegularUnitPrice, tfPeakUnitPrice;
