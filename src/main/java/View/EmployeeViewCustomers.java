...
public class EmployeeViewCustomers extends JFrame 
{
    ...
    public void init() {
        ...
        model = new DefaultTableModel(
                new Object[] { "CustomreID", "Name", "Address", "Phone", "Customer Type", "Meter Type",
                        "Connection Date", "Regular Units Consumed", "Peak Hour Units Consumed", "Edit", "Delete" },
                0);
    ...
    public void populateTable() {
        ...
        for (Customer customer : data) 
        {
            ...
            model.addRow(new Object[] {
                    ...
                    "Delete" });
            // rough
            // only confirmation message ie only the paid status can be updated.. oppps not
            // here but in bill. iska idk rn
    ...
    public void handleEditButton(JTable table) {
    ...
    public void handleDeleteButton(JTable table) {
        int row = table.getSelectedRow();
        if (row != -1) {
            Customer customer = data.get(row);
    ...
    public void filterTable() {
        ...
        for (Customer customer : data) {
            ...
            if (custID.contains(searchText) || custName.contains(searchText) || custAddress.contains(searchText) ||
                    ...
                    ||
                    connectionDate.contains(searchText) || regularUnits.contains(searchText)
                    || peakUnits.contains(searchText)) {
