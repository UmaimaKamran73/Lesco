...
public class EmployeeEditCustomer extends JFrame 
{
    ...
    // Type","Connection Date","Regular Units Consumed","Peak Hour Units Consumed"
    public JLabel jlTitle;
    public JLabel jlCustID, jlName, jlAddress, jlPhone, jlCNIC;
    public JLabel jlCustType, jlMeterType;
    public JLabel jlConnectionDate;
    public JLabel jlRegularUnitsConsumed, jlPeakHourUnitsConsumed;

    public JTextField tfAddress, tfPhone;
    public JTextField tfRegularUnitsConsumed, tfPeakHourUnitsConsumed;

    public JButton jbUpdate, jbCancel;
    ...
    public void handleUpdate() {
        ...
        if (tfPhone.getText().isEmpty() || tfAddress.getText().isEmpty() || tfRegularUnitsConsumed.getText().isEmpty()
                ||
                (customer.getMeterType().equals(MeterType.THREE_PHASE)
                        && tfPeakHourUnitsConsumed.getText().isEmpty())) {
            javax.swing.JOptionPane.showMessageDialog(this, "All fields must be filled.", "Input Error",
        ...
        if (phoneNumber.length() != 11 || !phoneNumber.matches("\\d{11}")) {
            javax.swing.JOptionPane.showMessageDialog(this, "Please enter a valid 11-digit phone number.",
        ...
        // Checking if the address contains a comma (BECAUSE THE DELIMETER USED IN TEEXT
        // FILES IS COMMA)
        if (address.contains(",")) {
            javax.swing.JOptionPane.showMessageDialog(this, "Please enter a valid address without a comma.",
                    "Input Error", javax.swing.JOptionPane.ERROR_MESSAGE);
        ...
        try {
            ...
            // Call the controller's method to update the customer in the database or
            // storage
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Please enter valid numbers for units consumed.",
                    "Input Error", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
    }
