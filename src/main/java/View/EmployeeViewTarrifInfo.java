...
public class EmployeeViewTarrifInfo extends JFrame
{
    ...
    private void init() 
    {
        ...
        //center ie table
        model=new DefaultTableModel(new Object[]{"Meter Type","Customer Type","Regular Unit Price","Peak Hour Unit Price","Fixed Charges","Percentage of Tax","Update"},0);
        ...
        table.getColumn("Update").setCellEditor(new EmployeeViewTarrifInfo.ButtonEditor(new JCheckBox(), this, empController));
    ...
    private void handleEdit(TarrifTax tarrif) 
    {
...
class ButtonEditor extends DefaultCellEditor
{
    ...
    private EmployeeViewTarrifInfo view; // Reference to the main view
    private EmployeeController empController;
    private TarrifTax tarrif;
    ...
    public Object getCellEditorValue()
    {
        ...
        if (isPushed)
        {
            TarrifTax tarrif = empController.getTarrifAt(table.convertRowIndexToModel(table.getSelectedRow())); // Get the correct tarrif based on the selected row
