...
public class EmployeeViewBills extends JFrame 
{
    ...
    // will become editable(only the status will be changed thou.
    // may be I can do it like displaying only 1 option or making the whole
    // different page by ourselves
    public JTable table;
    ...
    public void init() {
        ...
        model = new DefaultTableModel(new Object[] { "CustomerID", "Name", "Month", "Current Regular Meter Reading",
                "Current Peak Meter Reading", "Total Amount", "Due Date", "Bill Status", "Payment Date", "Update",
                "Delete" }, 0);
        ...
        for (Billing bill : data) {
            ...
            if (String.valueOf(bill.getCustID()).toLowerCase().contains(searchText) ||
                    ...
                    (bill.getBillPaidStatus().equals(BillStatus.PAID)
                            ? String.valueOf(bill.getBillPaymentDate()).toLowerCase()
                            : "N/A").contains(searchText)) {
                ...
                model.addRow(new Object[] {
                        ...
                        bill.getDueDate(),
                        bill.getBillPaidStatus(),
                        (bill.getBillPaidStatus().equals(BillStatus.PAID)) ? String.valueOf(bill.getBillPaymentDate())
                                : "N/A",
    ...
    public void handleUpdatePaidStatus(Billing bill) {
        ...
        if (success) {
            ...
            JOptionPane.showMessageDialog(this, "Bill status updated successfully!", "Success",
    ...
    public void handleDeleteBillRecord(Billing bill) {
    ...
    class ButtonEditor extends DefaultCellEditor {
        ...
        public EmployeeController empController;
        public EmployeeViewBills view;
        public Billing bill; // Hold the current bill being edited
