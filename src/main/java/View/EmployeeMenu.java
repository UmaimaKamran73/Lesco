...
public class EmployeeMenu extends JFrame {
    public JButton jbViewBillReport, jbViewExpiringCNICReport;
    public JButton jbViewBills, jbViewCustomers;
    public JButton jbAddNewMeter, jbAddBill;
    public JButton jbChangePassword, jbLogout;
    public JButton jbViewTarrifInfo;
    ...
    private void handleViewBillsReport()
    {
        ...
        new EmployeeViewBillsReport(empController, (List<Integer>) bills);  //ut shouldn't it be list?
    }
        /*private void handleViewBillsReport() {
