...
public class EmployeeInstallNewMeter extends JFrame {
    public JLabel jlCNIC, jlName, jlAddress, jlPhoneNumber, jlCustType, jlMeterType;
    public JTextField tfCNIC, tfName, tfAddress, tfPhoneNumber;
    public JRadioButton rbSinglePhase, rbThreePhase, rbDomestic, rbCommercial; // Radio buttons for meter type
    public ButtonGroup bgMeterType, bgCustType;
    public JButton jbInstallMeter;
    ...
    public void handleInstallMeter() {
        ...
        if (!empController.isValidCNIC(cnic)) {
            JOptionPane.showMessageDialog(null, "Invalid CNIC format. Must be 13 digits.", "Input Error",
