...
{
    JLabel jlCustomerID;
    JLabel jlCustomerName;
    JLabel jlAddress;
    JLabel jlPhoneNumber;
    JLabel jlCustomerType;
    JLabel jlMeterType;
    JLabel jlRegularUnitsConsumed;
    JLabel jlPeakHourUnitsConsumed;
    JLabel jlConstOfElectricity;
    JLabel jlTax;
    JLabel jlFixedCharges;
    JLabel jlTotalAmountDue;
    JLabel jlDueDate;
    JLabel jlPaymentStatus;
    JLabel TarrifTaxInfo; //4 rows will be there. grid will be made. rn idk what to do.may be when making employee I can use something from there
    private JLabel jlTarrifTitle;
    private JLabel jlRegularTarrif;
    private JLabel jlPeakTarrif;
    private JLabel jlTaxTarrif;
    private JLabel jlFixedTarrif;
    ...
    CustomerViewCurrentBill2(CustomerController custController, Map<String, String> billDetails) 
    {
    ...
    private void init(Map<String, String> billDetails)
{
        ...
        jlRegularUnitsConsumed = new JLabel("Regular Units Consumed: "+ billDetails.get("RegularUnitsConsumed"));// + regularUnitsConsumed);
        jlRegularUnitsConsumed.setFont(normalFont);
        
        jlPeakHourUnitsConsumed = new JLabel("Peak Hour Units Consumed: "+ billDetails.get("PeakHourUnitsConsumed") );//+ peakHourUnitsConsumed);
        jlPeakHourUnitsConsumed.setFont(normalFont);
        
        jlConstOfElectricity = new JLabel("Cost of Electricity: "+ billDetails.get("ElectricityCost"));// + costOfElectricity);
