...
public class CustomerUpdateCNICExpiryDate extends JFrame {
    public JLabel jlCNIC;
    public JLabel jlExpiryDate;
    public JLabel jlNewExpiryDate;
    // JXDatePicker datePickerNewExpiry;
    public JTextField tfNewExpiryDate;
    ...
    public void init()// String cnic, String expiryDate)
    {
