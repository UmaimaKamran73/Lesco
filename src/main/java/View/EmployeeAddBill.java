...
public class EmployeeAddBill extends JFrame {
    public JLabel jlCustID, jlCurrRegularMeterReading, jlCurrPeakMeterReading;
    public JTextField tfCustID, tfCurrRegularMetterReading, tfCurrPeakMeterReading;
    public JButton jbAddBill;
