...
public class EmployeeChangePassword extends JFrame {
    public JLabel jlUsername, jlCurrentPassword, jlNewPassword, jlConfirmPassword;
    public JPasswordField pfCurrentPassword, pfNewPassword, pfConfirmPassword;
    public JButton jbChangePassword;
    ...
    public void handleChangePassword() {
        ...
        if (newPassword == null ? confirmPassword != null : !newPassword.equals(confirmPassword)) {
            JOptionPane.showMessageDialog(this, "Error: New password and confirm password do not match.", "Error",
                    JOptionPane.ERROR_MESSAGE);
        } else if (!currentPassword.equals(empController.getPassword())) {
            JOptionPane.showMessageDialog(this, "Error: Current Password is incorrect", "Error",
                    JOptionPane.ERROR_MESSAGE);
        } else {
