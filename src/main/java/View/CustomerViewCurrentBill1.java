...
public class CustomerViewCurrentBill1 extends JFrame {
    ...
    public JRadioButton rbSinglePhase, rbThreePhase; // Radio buttons for meter type
    public JLabel jlMeterReading;
    public JTextField tfMeterReading;
    public ButtonGroup bgMeterType;
    public JButton jbViewBill;
    ...
    private void handleViewBill() {
        try {
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Please enter a valid meter reading.", "Input Error",
                    javax.swing.JOptionPane.ERROR_MESSAGE);
        }
    }
